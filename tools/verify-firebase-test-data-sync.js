...
async function findForbiddenReferences(db, pageSize) {
...
async function main(argv = process.argv.slice(2)) {
  ...
  const residualReferences = await findForbiddenReferences(destinationDb, args.pageSize);
...
module.exports = { METRICS, findForbiddenReferences, parseArgs };
