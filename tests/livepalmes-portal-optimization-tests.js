...
assert.ok(portalHtml.includes('livepalmes-admin-portal.js?v=20260913-relay-removal'));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260913-relay-removal"));
