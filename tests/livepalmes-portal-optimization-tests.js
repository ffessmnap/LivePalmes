...
assert.ok(portalHtml.includes('livepalmes-admin-portal.js?v=20260919-sidebar-1'));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.css?v=20260919-sidebar-1"));
