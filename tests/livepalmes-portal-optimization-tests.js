...
assert.ok(engagementCompetitionListSource.includes("engagementClubEntryCompetitionIds(allCalendarCompetitions, clubContext.clubId, seasonEndYears.map(String))"));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260817-portal-reads-1"));
