...
assert.ok(engagementCompetitionListSource.includes("engagementClubEntryCompetitionIds(calendarCompetitions, clubContext.clubId)"));
assert.ok(engagementCompetitionListSource.includes("calendarCompetitions.length + clubEntryQueryBatches"));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.css?v=20260817-club-admins-1"));
assert.ok(portalHtml.includes("assets/livepalmes-portal-ux.js?v=20260815-dtn-loading-indicator-1"));
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260817-club-admins-1"));
