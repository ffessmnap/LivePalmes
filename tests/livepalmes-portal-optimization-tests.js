...
assert.ok(portalHtml.includes('livepalmes-admin-portal.js?v=20260909-national-exceptions'));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260909-national-exceptions"));
