...
assert.ok(portalHtml.includes('livepalmes-admin-portal.js?v=20260820-program-phases-1'));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.css?v=20260820-program-phases-1"));
assert.ok(portalHtml.includes("assets/livepalmes-portal-ux.js?v=20260818-long-operations-1"));
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260820-program-phases-1"));
