...
assert.ok(portalHtml.includes('livepalmes-admin-portal.js?v=20260819-calendar-status-2'));
assert.ok(portalHtml.includes('livepalmes-admin-calendar-events.js?v=20260819-calendar-status-2'));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260819-calendar-status-2"));
