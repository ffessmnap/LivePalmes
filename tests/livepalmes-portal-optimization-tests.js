...
const clubTimesDialogOpenSource = portal.slice(portal.indexOf("function openEngagementClubTimesDialog"), portal.indexOf("function closeEngagementClubTimesDialog"));
assert.equal(clubTimesDialogOpenSource.includes("ensureEngagementClubSwimmerEventTimes"), false);
