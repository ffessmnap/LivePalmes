...
assert.ok(portalHtml.includes('livepalmes-admin-portal.js?v=20260909-qualification-automatic-times'));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260909-qualification-automatic-times"));
