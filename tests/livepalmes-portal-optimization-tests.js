...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.css?v=20260819-club-cache-10"));
assert.ok(portalHtml.includes("assets/livepalmes-portal-ux.js?v=20260818-long-operations-1"));
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260819-club-cache-10"));
