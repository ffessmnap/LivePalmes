...
assert.ok(portalHtml.includes('livepalmes-admin-portal.js?v=20260920-workspaces-1'));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260920-workspaces-1"));
