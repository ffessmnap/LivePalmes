...
assert.ok(portalHtml.includes('livepalmes-admin-portal.js?v=20260820-international-1'));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260820-international-1"));
