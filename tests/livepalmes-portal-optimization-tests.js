...
assert.ok(portalHtml.includes('livepalmes-admin-portal.js?v=20260903-license-control-route-1'));
...
assert.ok(portalHtml.includes("assets/livepalmes-admin-portal.js?v=20260903-license-control-route-1"));
