...
3. la production reste un lancement manuel depuis `main`, protege par l'environnement GitHub `production` ;
4. le workflow de production relance la verification avant de deployer uniquement Hosting.
