...
- Suppression des derniers acces implicites `with (context)` dans les modules diagnostics, panneau nageur, gestion des resultats, forfaits/finales et synchronisation console.
