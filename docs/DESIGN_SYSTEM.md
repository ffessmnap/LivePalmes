...
Dans une fiche compétition, aucun bandeau permanent ne répète la phase de préparation ou l’état des engagements déjà visible dans l’en-tête. L’en-tête aligne sur ordinateur le nom de la compétition à gauche et les badges de niveau et d’état à droite, avec la date et le lieu immédiatement sous le nom ; les badges partagent exactement les mêmes hauteur, padding et taille de texte. Sur mobile, ils repassent sous la date et le lieu. Les onglets commencent directement sous cet en-tête ; seuls les retours ponctuels utiles de chargement, d’enregistrement ou d’erreur apparaissent lorsque nécessaire. La navigation compacte reste fixée sous l’en-tête principal pendant le défilement : les quatre grandes étapes restent visibles sur la première ligne, tandis qu’une seconde ligne ne montre les sous-onglets de l’étape active que lorsqu’il en existe plusieurs. Dans l’espace Club, la quatrième étape porte directement le nom « Récapitulatif » et ne répète donc pas ce bouton sous la navigation. Elle ne repose ni sur un menu déroulant ni sur un défilement horizontal. Les intitulés « Programme » et « Courses individuelles » distinguent clairement la configuration des épreuves de l’engagement des nageurs.
