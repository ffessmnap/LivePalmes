...
Le statut d’activité des nageurs du club est persistant. Dans Mes nageurs, les actifs précèdent les inactifs avec un séparateur discret ; chaque groupe reste alphabétique et une action compacte permet au club de modifier le statut. Dans la sélection des engagements, la vue sans recherche montre tous les nageurs actifs sous le volet d’ajout, tandis qu’une recherche saisie continue de couvrir actifs et inactifs.
