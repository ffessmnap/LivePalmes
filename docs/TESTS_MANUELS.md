...
- Après avoir créé une compétition, cliquer de nouveau sur « Ajouter une compétition » : tous les champs et messages doivent retrouver leur état initial. Avec « Tous les temps connus », les dates de début et de fin de période doivent être vides, désactivées et non obligatoires. Les régions invitées, frais et sections facultatives de la création précédente ne doivent pas persister ; seule la région imposée par un droit régional peut être automatiquement réappliquée.
