(function () {
  ...
  function labelsApi() {
    return window.LivePalmesProgramNavigationLabels.create({
      isRelayEntrant,
      livePalmesRaceCore,
      normalizePdfLabel,
      sameCategory,
  ...
  function comparableEventId(value) { return labelsApi().comparableEventId(value); }
  function eventSignature(value) { return labelsApi().eventSignature(value); }
  function recordEventMatches(recordEventId, eventId) { return labelsApi().recordEventMatches(recordEventId, eventId); }
  function recordMatchesRace(record, eventId = state.eventId, sex = state.sex) { return labelsApi().recordMatchesRace(record, eventId, sex); }
  function isFinalStage(stage) { return labelsApi().isFinalStage(stage); }
  function finalStageLabel(stage) { return labelsApi().finalStageLabel(stage); }
  function isFemaleContext(sex = state.sex) { return labelsApi().isFemaleContext(sex); }
  function sexDisplayLabel(sex = state.sex) { return labelsApi().sexDisplayLabel(sex); }
  function categoryLabel(category, sex = state.sex) { return labelsApi().categoryLabel(category, sex); }
  function entrantWord(count = 2, sex = state.sex) { return labelsApi().entrantWord(count, sex); }
  function swimmerWord(count = 1, sex = state.sex) { return labelsApi().swimmerWord(count, sex); }
  function displayedWord(count = 2, sex = state.sex) { return labelsApi().displayedWord(count, sex); }
