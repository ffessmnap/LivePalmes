(function () {
  ...
  function renderSwimmerDetails() {
    ...
    swimmerDetails.innerHTML = window.LivePalmesSwimmerDetailsView.render({
      categoryClass,
      categoryLabel,
      compactProgramPerformanceLabel,
      competitionStats: findCompetitionStatsForEntrant(swimmer),
      entries,
      escapeHtml,
      eventLabel,
      formatName,
      ...
      shortEventLabel,
      swimmer,
      swimmerInfos: findSwimmerInfosForEntrant(swimmer)
    });
  }
